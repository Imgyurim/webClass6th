...
$(document).ready(function(){
    ...
    //     $(cssSelector+" b").css("opacitiy","0").css("line-height","1").css("display","inline-block").css("font-size",option.textSize+"px")
    
    //     for(let i=0 ; i<$(cssSelector+" b").length ; i++){
    //         $(cssSelector+" b:nth-of-type("+(i+1)+")").css("animation"," introAni "+ animationDuration*i +"s ease "+(animationTerm*i)+"s forwards")
